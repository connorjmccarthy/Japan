...
const SHELL = ['./', './index.html', './styles/app.css', './src/main.js', './src/util.js', './src/ui.js', './src/store.js', './src/github.js', './src/ics.js', './src/daymap.js', './src/crypto.js',
  './src/views/overview.js', './src/views/itinerary.js', './src/views/go.js', './src/views/flights.js', './src/views/stays.js', './src/views/food.js', './src/views/budget.js', './src/views/checklist.js', './src/views/map.js', './src/views/vault.js', './src/views/decisions.js', './src/views/souvenirs.js', './src/views/settings.js',
