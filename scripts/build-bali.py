...
days = [
    ...
    day('2026-11-09', 'FINNS Beach Club', 'Villa Bunia, Canggu',
        'The paid day. A$522 has already gone on FINNS, which for five people is a daybed or cabana package rather than just entry, so check what it actually includes before you go and make it count. Nothing else is scheduled: it is a full day of pools, food and sun.',
        [
            ...
            item('g2', '11:00', 'activity', 'FINNS Beach Club', location='FINNS Beach Club, Berawa (11am-midnight)', endTime='18:30', cost=522, currency='AUD', split=GROUP, status='booked',
                 notes='PAID: A$522 through Wanderlog, logged as Food. Work out exactly what that bought before the day: FINNS sells entry passes, daybeds, cabanas and minimum-spend packages, and they are not the same thing. If it is a minimum spend, it is credit at the bar rather than money gone. Things worth knowing: it is a ten-minute walk from the villa so nobody needs to ride; there are multiple pools including a swim-up bar and an adults-only area; take cash and a card because they run a wristband tab; bring your own towel to avoid the deposit; and it gets extremely loud from mid-afternoon. Book the daybed for the earliest slot you can, because the good ones go by noon.'),
...
checklist = [
    ...
    dict(id='bk2', group='Before you book anything else', text='Confirm whether the A$2,655 Jetstar charge is the whole group or just you, and fix the split on the budget line', due='2026-09-25'),
    dict(id='bk3', group='Before you book anything else', text='Put the villa\'s nightly price into Stays so the budget is not missing its biggest line', due='2026-10-01'),
    ...
    dict(id='bk13', group='Bookings', text='Find out exactly what the A$522 FINNS booking includes, and reserve the daybed slot', due='2026-10-20'),
    ...
    dict(id='bk18', group='A week out', text='Cash plan: no need for much. Card works nearly everywhere; take A$200 for warungs, markets and drivers', due='2026-11-01',
...
questions = [
    ...
    dict(id='bq2', question='Is the A$2,655 Jetstar charge the whole group, or just you?',
